						...
						<ul
							...
							<li class="nav-item" style="padding-right: -15px;"><a
								class="nav-link link" href="assignment_assign.html">ASSIGNMENT
									ASSIGNING</a></li>
							<li class="nav-item" style="padding-right: -15px;"><a
								class="nav-link link" href="assignment_assign.html">MATERIALS</a></li>
							...
							<li class="nav-item dropdown open" style="padding-right: -15px;">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="staff_profile.html"
	...
	<div class="container" style="margin: 150px 0;">
		...
		<table class="stud" width="90%"
			...
			<%
				...
				String sql = "select w._id as allotId, p.id as course_id, p.course_name, g.id as student_id, g.name as student_name, "
						...
						+ "left join accounts s on s.course LIKE p.course_name where s.id = "+currentUser.getId();
			...
			<tr>
				...
				%>
				<td><a
					href="${pageContext.request.contextPath}/CourseDetails?action=alloted&allotid=<%=rs.getInt(1)%>&sid=<%=rs.getInt(6)%>"><%=status%></a></td>
			</tr>
			<%
				}
				} catch (Exception ex) {
