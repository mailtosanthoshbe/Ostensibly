						...
						<ul
							...
							<li class="nav-item dropdown open" style="padding-right: -15px;"><a
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="${pageContext.request.contextPath}/UserDetails?user_type=staff"
										style="padding-right: -30px;">STAFF DETAILS</a> <a
										class="dropdown-item" href="${pageContext.request.contextPath}/UserDetails?user_type=student"
